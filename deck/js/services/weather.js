/**
 * weather.js
 * Deck — Dhaka Live Weather Service using Open-Meteo API (Free, keyless)
 */

const CACHE_KEY = 'deck_weather_cache';
...
export async function fetchDhakaWeather() {
  ...
  try {
    ...
    console.warn('[Deck Weather] Cache read error', e);
  }
  ...
  try {
    ...
    console.warn('[Deck Weather] Live weather fetch failed, using fallback', err);
    return {
      temp: 29,
